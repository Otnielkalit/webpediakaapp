        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    @forelse ($laporanDiproses as $laporan)
                        <tr>
                            <td>
                                ...
                                <strong><a
                                        href="{{ route('laporan.detail-diproses', ['no_registrasi' => $laporan['no_registrasi']]) }}">{{ $laporan['no_registrasi'] }}</a></strong>
                            </td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center"><h1>Belum ada Laporan yang diproses</h1></td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
